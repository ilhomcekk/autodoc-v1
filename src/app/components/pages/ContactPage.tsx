  ...
  const contactInfo = [
    {
      ...
      sublabel: t("headOffice"),
    },
    {
      icon: Phone,
      label: t("phone"),
      value: "+998 71 200 00 00",
      sublabel: "Пн — Пт, 09:00 — 18:00",
      href: "tel:+998712000000",
    },
    {
      icon: Mail,
      label: "Email",
      value: "info@autodoc.uz",
      sublabel: t("respondWithin24Hours"),
  ...
  return (
    <div>
      ...
      <section className="pt-[72px] relative">
        <img src={images.Contacts} className="absolute top-0 left-0 w-full h-full object-cover" alt="Partners" />
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 lg:px-12 py-12 sm:py-16 lg:py-24">
          <motion.div
          ...
          >
            ...
            <p
              className="text-[#888] max-w-[480px]"
              style={{
            ...
            {contactInfo.map((item, i) => {
              ...
              const content = (
                <div className="bg-white group hover:bg-[#f8faf8] transition-colors duration-300 p-6 sm:p-8 lg:p-10">
                  ...
                  <span
                    className="text-[11px] tracking-[0.2em] uppercase text-[#999] block mb-2"
                    style={{ fontWeight: 600 }}
                  >
                    {item.label}
                  </span>
                  <p
                    className="text-[#1a1a1a] text-[14px] sm:text-[15px] mb-1"
                    style={{ fontWeight: 600 }}
                  >
                    {item.value}
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-5">
              <AnimatedSection>
                ...
                <p
                  className="text-[#999] text-[14px] mb-8 sm:mb-10"
                ...
                <div className="h-[350px] sm:h-[450px] lg:h-full lg:min-h-[500px] bg-[#e8ece8] relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <span
                        className="text-[13px] text-[#666] block mb-1"
                        style={{ fontWeight: 600 }}
                      >
                        Ташкент, Узбекистан
                      </span>
                      <span
                        className="text-[11px] text-[#999] tracking-[0.1em] uppercase"
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div
                      className="w-32 h-32 rounded-full bg-[#2E7D32]/10 animate-ping"
